...
function global:au_GetLatest {
	...
	$url32 = ($Links | Where-Object {$_.href -match 'windows_386_'} | Select-Object -First 1).href
	$url64 = ($Links | Where-Object {$_.href -match 'windows_amd64'} | Select-Object -First 1).href
