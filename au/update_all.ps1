...
$Options = [ordered]@{
    ...
    History = @{
        ...
        Path = "$PSScriptRoot\Update-History.md"            #Path to store history
    }

    Report = @{
        Type = 'markdown'                                   #Report type: markdown or text
        Path = "$PSScriptRoot\Update-AUPacakges.md"         #Path to store the report
    ...
    RunInfo = @{
        ...
        Path    = "$PSScriptRoot\update_info.xml"           #Path to the run info
    }
