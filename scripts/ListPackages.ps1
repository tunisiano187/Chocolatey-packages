...
foreach ($path in $paths) {
    ...
    Add-Content $mdfile "| [![](http://img.shields.io/chocolatey/dt/$package.svg)](https://chocolatey.org/packages/$package) | [![](https://img.shields.io/chocolatey/v/$($package)?color=green&label=$package)](https://github.com/tunisiano187/Chocolatey-packages/tree/master/automatic/$package)|[![Packaging status](https://repology.org/badge/vertical-allrepos/$package.svg)](https://repology.org/project/$package/versions)|"
}
git add $mdfile
